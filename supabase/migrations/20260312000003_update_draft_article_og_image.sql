-- Add og_image_url parameter to update_draft_article RPC
-- Allows the blog review editor to save a featured image URL when publishing.
...
REVOKE ALL ON FUNCTION update_draft_article(UUID, TEXT, TEXT, TEXT) FROM anon;
GRANT EXECUTE ON FUNCTION update_draft_article(UUID, TEXT, TEXT, TEXT) TO authenticated;
