...
(NULL, 'Review Request', 'Ask for review after 3+ visits', 'behavioral', 'review_request', TRUE, 'condition', '{"visit_count_gte": 3, "no_review_requested": true}', 'send_message', '{"channel": "email", "template_key": "review_request", "platforms": ["google", "yelp"]}', TRUE, 0.70),
