...
// Loaders + section builder now live in _shared/knowledge.ts (single source of
// truth, reused by generate-article + analyze-suggestion). Re-exported here so
// existing `./knowledge.ts` imports across index.ts / tools.ts stay untouched.
export {
